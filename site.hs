...
feedConfig = FeedConfiguration {
        feedTitle       = "cambridge.maths.org",
        feedDescription = "Cambridge Mathematics Education Project Update",
        feedAuthorName  = "CMEP",
        feedAuthorEmail = "cmep@maths.cam.ac.uk",
        feedRoot        = "http://cambridge.maths.org"
    }
