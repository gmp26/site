(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("generator", "Generate the site html, javascripts and CSS.", function(){
      var metadata, sources, families, pervasiveIdeas, pervasiveIdeasHome, resources, resourceTypes, stations, sourcesDir, partialsDir, appDir, _head, _nav, _foot, _linesMenu, _piMenu, getResourceData, getPervasiveIdeaData, meta, layout, html, content, pvid, data, resourceName, files, indexMeta, stid, lastFolder, folder, items, noop;
