(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("generator", "Generate the site html, javascripts and CSS.", function(){
      var metadata, sources, sourcesDir, partialsDir, appDir, _head, _nav, _foot, _linesMenu, _piMenu, getResourceData, getPervasiveIdeaData, lastFolder, folder, items, resources, resourceName, files, indexMeta, layout, content, html, pervasiveIdeas, pvid, data, meta, resourceTypes, fileName;
