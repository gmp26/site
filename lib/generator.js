(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("generator", "Generate the site html, javascripts and CSS.", function(){
      var metadata, sources, sourcesDir, partialsDir, appDir, _head, _nav, _foot, getResourceData, lastFolder, folder, items, resources, resourceName, files, indexMeta, layout, content, html, pervasiveIdeas, fileName, meta;
