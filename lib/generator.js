(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("generator", "Generate the site html, javascripts and CSS.", function(){
      var metadata, sources, families, pervasiveIdeas, pervasiveIdeasHome, examQuestions, resources, resourceTypes, stations, sourcesDir, partialsDir, appDir, _head, _nav, _foot, _linesMenu, _piMenu, getExamQuestionPartData, getResourceData, getPervasiveIdeaData, meta, layout, html, content, pvid, data, acks, referenceFor, createStationRT13s, st13s, pi13s, eqid, indexMeta, ref$, i$, len$, id, rt13, stid, rt13Sorted, partition, key, subset, resid, resourceName, files;
      ...
      referenceFor = function(qmeta){
        var ref$;
        return {
          ref: [(ref$ = qmeta.source) != null ? ref$ : eqid, (ref$ = qmeta.year) != null ? ref$ : "null", (ref$ = qmeta.paper) != null ? ref$ : "null", (ref$ = qmeta.qno) != null ? ref$ : "null"].join(', '),
      ...
      createStationRT13s = function(stid, rt13Sorted, resid){
        ...
        insertAt = _.sortedIndex(R1s, resMeta, function(meta){
          var ref$;
          return +meta.rt.substr(2) + (ref$ = meta.id)[ref$.length - 1] / 10;
        });
        return stations[stid].meta.R1s = R1s.splice(insertAt, 0, resMeta);
      };
      st13s = {};
      pi13s = {};
