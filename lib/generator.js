(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("generator", "Generate the site html, javascripts and CSS.", function(){
      var metadata, sources, families, pervasiveIdeas, pervasiveIdeasHome, examQuestions, resources, resourceTypes, stations, sourcesDir, partialsDir, appDir, _head, _nav, _foot, _linesMenu, _piMenu, getExamQuestionPartData, getResourceData, getPervasiveIdeaData, meta, layout, html, content, pvid, data, st13s, pi13s, eqid, indexMeta, ref$, i$, len$, id, rt13, stid, rt13Sorted, rt13html, resid, dirFiles, j$, len1$, f, ext, R1s, ref1$, resourceName, files;
