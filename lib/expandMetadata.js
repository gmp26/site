  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("expandMetadata", "Expand metadata for efficiency.", function(){
      ...
      _.each(resources, function(resource, resourceId){
        ...
        expandIds = function(objList, idPrefix, idNumber){
          ...
          _.each(srcList, function(id){
            var obj, objMeta, resListId, oml, res;
            obj = objList[id];
      ...
      _.each(resources, function(resource, resourceId){
        ...
        return _.each(highlights, function(station, stid){
          var st;
          st = station.meta;
          if (!st) {
            return grunt.log.error("Ignoring undefined station at " + resourceId + ", stid=" + stid);
          } else {
            return _.each(st.R1s, function(obj){
