(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("expandMetadata", "Expand metadata for efficiency.", function(){
      var options, partialsDir, sourcesDir, metadata, sources, stations, pervasiveIdeas, resources, resourceTypes, lines, examQuestions, clearanceLevel, id, file, fileClearance, ref$, ref1$, ref2$, censor, badLines, badPVs, badStations, stationsByLine, badResources, fams;
