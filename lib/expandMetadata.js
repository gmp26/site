...
module.exports = function(grunt){
  ...
  return grunt.registerTask("expandMetadata", "Expand metadata for efficiency.", function(){
    var options, partialsDir, sourcesDir, metadata, sources, stations, pervasiveIdeas, resources, resourceTypes, lines, examQuestions, clearanceLevel, id, file, fileClearance, ref$, ref1$, ref2$, censor, data, badLines, badPVs, badStations, stationsByLine, badResources, fams;
    ...
    if (clearanceLevel > 0) {
      ...
      for (id in resources) {
        file = resources[id];
        fileClearance = +((ref$ = (ref1$ = file.index) != null ? (ref2$ = ref1$.meta) != null ? ref2$.clearance : void 8 : void 8) != null ? ref$ : 0);
      ...
      for (id in examQuestions) {
        file = examQuestions[id];
        fileClearance = +((ref$ = (ref1$ = file.index) != null ? (ref2$ = ref1$.meta) != null ? ref2$.clearance : void 8 : void 8) != null ? ref$ : 0);
        censor = fileClearance < clearanceLevel;
        if (censor) {
      ...
      for (id in stations) {
        data = stations[id];
        fileClearance = +((ref$ = (ref1$ = data.meta) != null ? ref1$.clearance : void 8) != null ? ref$ : 100);
        censor = fileClearance < clearanceLevel;
        if (censor) {
