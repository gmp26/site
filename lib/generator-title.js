(function(){
  ...
  module.exports = function(grunt){
    ...
    return grunt.registerTask("generator", "Generate the site html, javascripts and CSS.", function(){
      var options, metadata, sources, stations, pervasiveIdeas, resources, resourceTypes, lines, sourcesDir, partialsDir, lastFolder, folder, items, resourceName, files, index, fileName, meta;
