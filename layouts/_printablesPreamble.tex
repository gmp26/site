...
\newfontfamily\ChalkFont[Path = ../../../app/fonts/]{Chalkboard.ttc}
...
\definecolor{navbarbackground}{HTML}{000000}
\definecolor{navbartext}{HTML}{999999}
...
\fancyhead[C]{{%
  ...
  \colorbox{navbarbackground}{%
    \makebox[\headwidth][l]{% this ensures we have content the full width of the page
      ...
      \raisebox{-0.5\height}{\hspace{5pt}\includegraphics[height=20pt]{cmep-logo3.png}}%
      ...
      \hfill%
      \raisebox{-5pt}{\rightmark\hspace{5pt}}}%
    }%
  }%
...
\definecolor{chalkborder}{HTML}{FFA500}
\global\mdfdefinestyle{chalk}{%
backgroundcolor=chalkbackground,%
middlelinewidth=1pt,% weirdly the middle line is drawn underneath the dashed one added below
...
tikzsetting={draw=chalkborder,dashed,line width=1pt,dash pattern = on 5pt off 5pt}%
}
